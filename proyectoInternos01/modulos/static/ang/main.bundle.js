...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__app_static_services_authentication_service__ = __webpack_require__("./src/app/static/services/authentication.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__app_obj_list_obj_list_component__ = __webpack_require__("./src/app/obj-list/obj-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__app_static_dialog_edit_edit_component__ = __webpack_require__("./src/app/static/dialog/edit/edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__static_dialog_loggin_loggin_component__ = __webpack_require__("./src/app/static/dialog/loggin/loggin.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["K" /* NgModule */])({
            imports: [
                ...
                // core & shared
                __WEBPACK_IMPORTED_MODULE_4__app_core__["c" /* CoreModule */],
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_8__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_13__app_obj_list_obj_list_component__["a" /* ObjListComponent */], __WEBPACK_IMPORTED_MODULE_10__static_dialog_delete_delete_component__["a" /* DeleteComponent */], __WEBPACK_IMPORTED_MODULE_14__app_static_dialog_edit_edit_component__["a" /* EditComponent */], __WEBPACK_IMPORTED_MODULE_11__app_static_services_filter_pipe__["a" /* FilterPipe */]],
            providers: [__WEBPACK_IMPORTED_MODULE_9__app_static_dialog_add_add_component__["a" /* AddComponent */], __WEBPACK_IMPORTED_MODULE_12__app_static_services_authentication_service__["a" /* AuthenticationService */]],
...
var AuthEffects = (function () {
    ...
    AuthEffects.prototype.login = function () {
        var _this = this;
        return this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_5__auth_reducer__["c" /* AuthActionTypes */].LOGIN)
    ...
    AuthEffects.prototype.logout = function () {
        var _this = this;
        return this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_5__auth_reducer__["c" /* AuthActionTypes */].LOGOUT)
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators_tap__["a" /* tap */])(function (action) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return AuthActionTypes; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return selectorAuth; });
/* harmony export (immutable) */ __webpack_exports__["d"] = authReducer;
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__ngrx_store__["e" /* StoreModule */].forRoot({
                    auth: __WEBPACK_IMPORTED_MODULE_9__auth_auth_reducer__["d" /* authReducer */]
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_0__local_storage_local_storage_service__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_1__animations_router_transition__["b"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_2__auth_auth_reducer__["e"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_module__ = __webpack_require__("./src/app/core/core.module.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_3__core_module__["a"]; });
...
module.exports = "<div class=\"container\">\n     <br>\n  \n      <div class=\"row\">\n          <div class=\"col-12 col-lg-12\">\n            <h1 class=\"main-heading\">Tickets \n           \n              \n          <a *ngIf=\"af.authenticated\" mat-fab color=\"primary\" class=\"new pull-right\" (click)=\"addNew()\">\n              <mat-icon aria-label=\"Example icon-button with a heart icon\">add</mat-icon>\n          </a>\n         \n        </h1>    \n        </div>  \n      </div>      \n  \n  \n    \n  <mat-form-field color=\"primary\">\n   \n      <input matInput  [(ngModel)]=\"searchText\" placeholder=\"Filtrar\" >\n      \n  </mat-form-field>\n  \n  \n  \n  <br>\n  <br>\n\n\n \n    <div class=\"row align-items-end\">\n    <br>\n    <div  class=\"col-md-6 col-lg-6\"\n        *ngFor=\"let devps of dataService.employeeList | filter:searchText \">\n          <mat-card class=\"hvr\">\n            \n            <mat-card-title><code>{{devps.createdAt}}</code><div class=\"code\">{{devps.name}}</div></mat-card-title>\n            \n            <mat-card-subtitle> \n                {{devps.description}}.\n              </mat-card-subtitle>\n              <mat-card-title><code>Estado: {{devps.status.name}}</code></mat-card-title>\n                 <!-- <i class=\"fa fa-user fa-1x\"></i> {{devps.user.username}}. --> \n                 <div *ngIf=\"!dataService.isLoged\" >  \n                 <br>\n               </div>\n               \n                  \n            <mat-card-actions *ngIf=\"af.authenticated\">\n                <button mat-icon-button class=\"btn\" color=\"primary\" (click)=\"showForEdit(i, devps.id, devps.name, devps.description, devps.status.id)\">\n                    <mat-icon aria-label=\"Edit\">edit</mat-icon>\n                  </button>\n  \n                  <button mat-icon-button color=\"primary\" class=\"btn\" (click)=\"deleteItem(i, devps.id, devps.name, devps.user.username, devps.status.name)\">\n                      <mat-icon aria-label=\"Delete\">delete</mat-icon>\n                    </button>\n            </mat-card-actions>\n        \n          </mat-card>\n          <br>\n        </div>\n  \n    <br>\n    \n  </div>\n  \n  <br>\n\n</div>\n  \n<br>\n  \n  \n  "
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__static_services_authentication_service__ = __webpack_require__("./src/app/static/services/authentication.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ObjListComponent = (function () {
    ...
    ObjListComponent.prototype.showForEdit = function (i, id, name, description, status) {
        this.id = id;
    ...
    ObjListComponent.prototype.deleteItem = function (i, id, name, user, status) {
        this.index = i;
        this.id = id;
    ...
    ObjListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_material__["c" /* MatDialog */],
            __WEBPACK_IMPORTED_MODULE_4__static_services_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_7__static_services_authentication_service__["a" /* AuthenticationService */]])
    ], ObjListComponent);
...
var SettingsEffects = (function () {
    ...
    SettingsEffects = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__ngrx_effects__["a" /* Actions */],
            __WEBPACK_IMPORTED_MODULE_4__app_core__["d" /* LocalStorageService */]])
    ], SettingsEffects);
...
module.exports = "<div class=\"background\">\n  <div class=\"gradient\">\n    <div class=\"container\">\n\n        <mat-card>\n\n      <h1>Abre una Cuenta</h1>\n      <h2>Comienza. ¡Es gratis!</h2>\n      <mat-divider></mat-divider>\n\n      \n  \n\n        <div class=\"actions\">\n\n            <div class=\"form\">\n                <mat-form-field color=\"primary\">\n            <input matInput #input class=\"form-control\" placeholder=\"Nombre\"  name=\"name\" required >\n            </mat-form-field>\n            </div>\n            <div class=\"form\">\n                <mat-form-field color=\"primary\">\n            <input matInput #input class=\"form-control\" placeholder=\"Apellidos \"  name=\"lastname\" required >\n            </mat-form-field>\n            </div>\n            <div class=\"form\">\n                <mat-form-field color=\"primary\">\n            <input matInput #input class=\"form-control\" placeholder=\"Correo Electronico\"  name=\"email\" required >\n            </mat-form-field>\n            </div>\n            <div class=\"form\">\n                <mat-form-field color=\"primary\">\n            <input matInput #input class=\"form-control\" placeholder=\"Contraseña\"  name=\"password\" required >\n            </mat-form-field>\n            </div>\n            <mat-card-subtitle>\n              Al hacer clic en unirte, aceptas las Condiciones de uso, la Política de privacidad y la Política de cookies de LinkedIn.\n            </mat-card-subtitle>\n           \n            <a [ngClass]=\"animateOnRouteEnter\"\n               mat-raised-button color=\"primary\" routerLink=\"../features\">\n              Únete ahora\n            </a>\n\n            \n\n          </div>\n      \n    </mat-card>\n\n\n    </div>\n  </div>\n</div>\n"
...
var AddComponent = (function () {
    ...
    AddComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material__["e" /* MatDialogRef */],
            __WEBPACK_IMPORTED_MODULE_3__models_models__["a" /* Employee */],
...
module.exports = "<div class=\"container\">\n  <h3 mat-dialog-title>Editar Id: {{data.id}}</h3>\n  \n  \n\n  <form class=\"mat-dialog-content\"   #formControl=\"ngForm\">\n\n\n    <!--Textarea for demo purposes-->\n    <div class=\"form\">\n      <mat-form-field color=\"primary\">\n        <input matInput #input class=\"form-control\" placeholder=\"Nombre\" [(ngModel)]=\"data.name\" name=\"name\" required >\n        <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n      </mat-form-field>\n    </div>\n\n    <!--Contains mat-hint for characters count and has maxLengt set-->\n    <div class=\"form\">\n      <mat-form-field color=\"primary\">\n        <textarea matInput #input class=\"form-control\" placeholder=\"Descripcion\" [(ngModel)]=\"data.description\" name=\"description\" required ></textarea>\n        <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n      </mat-form-field>\n    </div>\n\n\n    <div class=\"form\">\n        <div class=\"form\">\n            <mat-form-field color=\"primary\">\n                <mat-select [(value)]=\"selected\" placeholder=\"Estado\" [(ngModel)]=\"data.status\"  name=\"status\" required>\n                  <mat-option *ngFor=\"let status of status\" [value]=\"status.value\" >\n                      {{ status.name }}\n                    </mat-option>\n                </mat-select>\n                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                </mat-form-field>\n            \n         \n        </div>\n    </div>\n\n\n    <div mat-dialog-actions> \n      <button mat-raised-button  color=\"accent\" [type]=\"submit\" [disabled]=\"!formControl.valid\"  (click)=\"stopEdit(data.id, formControl)\">Guardar</button>\n      <button mat-raised-button (click)=\"onNoClick()\" tabindex=\"-1\">Cancelar</button>\n    </div>\n    <br>\n  </form>\n\n</div>\n"
...
/***/ "./src/app/static/dialog/loggin/loggin.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\n    <h3 mat-dialog-title>Iniciar Sesion</h3>\n    \n    \n  \n    <form class=\"mat-dialog-content\"   #formControl=\"ngForm\">\n  \n        <button mat-raised-button  class=\"color\" (click)=\"onLoginGoogle()\">\n            <i class=\"fa fa-google-plus\" aria-hidden=\"true\"></i>\n             Ingresar con Google \n     </button>\n      <!--Textarea for demo purposes-->\n     <div class=\"form\">\n        <mat-form-field color=\"primary\">\n          <input matInput #input class=\"form-control\" placeholder=\"Correo Electronico\"  [(ngModel)]=\"data.email\" id=\"email\" name=\"email\" email required >\n          <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage_email()}}</mat-error>\n        </mat-form-field>\n      </div>\n\n      <div class=\"form\">\n          <mat-form-field color=\"primary\">\n            <input matInput type=\"password\" #input class=\"form-control\" [(ngModel)]=\"data.password\" placeholder=\"Contraseña\" id=\"password\" name=\"password\" required >\n            <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n          </mat-form-field>\n        </div>\n  \n\n\n      <div mat-dialog-actions> \n          \n        <button mat-raised-button  color=\"accent\" [type]=\"submit\" [disabled]=\"!formControl.valid\"  (click)=\"loggin(formControl)\">Ingresar</button>\n        <button mat-raised-button (click)=\"onNoClick()\" tabindex=\"-1\">Cancelar</button>\n      </div>\n      <br>\n    </form>\n  \n  </div>\n  "

/***/ }),

/***/ "./src/app/static/dialog/loggin/loggin.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/static/dialog/loggin/loggin.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_models__ = __webpack_require__("./src/app/static/models/models.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_authentication_service__ = __webpack_require__("./src/app/static/services/authentication.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LogginComponent = (function () {
    function LogginComponent(dialogRef, data, dataService, router, authentication) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.dataService = dataService;
        this.router = router;
    ...
    LogginComponent.prototype.getErrorMessage = function () {
        return this.formControl.hasError('required') ? 'Campo Requerido' :
            '';
    };
    LogginComponent.prototype.getErrorMessage_email = function () {
        return this.formControl.hasError('email') ? 'Ingrese un Email Valido' :
            '';
    };
    LogginComponent.prototype.ngOnInit = function () {
    };
    LogginComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    ...
    LogginComponent.prototype.onLoginGoogle = function () {
        var _this = this;
        this.dialogRef.close();
    ...
    LogginComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("./src/app/static/dialog/loggin/loggin.component.html"),
            styles: [__webpack_require__("./src/app/static/dialog/loggin/loggin.component.scss")]
        }),
        __param(1, Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["B" /* Inject */])(__WEBPACK_IMPORTED_MODULE_0__angular_material__["a" /* MAT_DIALOG_DATA */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_material__["e" /* MatDialogRef */],
            __WEBPACK_IMPORTED_MODULE_5__models_models__["b" /* User */], __WEBPACK_IMPORTED_MODULE_2__services_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_6__services_authentication_service__["a" /* AuthenticationService */]])
    ], LogginComponent);
...
/***/ "./src/app/static/models/models.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/app/static/services/authentication.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_authentication_service__ = __webpack_require__("./src/app/static/services/authentication.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataService = (function () {
    function DataService(http, router, af) {
        this.http = http;
        this.router = router;
        this.af = af;
    ...
    DataService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_5__services_authentication_service__["a" /* AuthenticationService */]])
    ], DataService);
    return DataService;
}());
...
var FilterPipe = (function () {
    ...
    FilterPipe.prototype.transform = function (value, filterBy) {
        ...
        return filterBy ? value.filter(function (fisrtname) {
            return fisrtname.name.toLocaleLowerCase().indexOf(filterBy) !== -1;
        }) : value;
    };
...
var routes = [
    { path: 'about', component: __WEBPACK_IMPORTED_MODULE_3__about_about_component__["a" /* AboutComponent */], data: { title: 'Inicio' } },
    {
        path: 'features',
